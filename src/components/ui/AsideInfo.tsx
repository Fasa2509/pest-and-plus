...
export const AsideInfo: FC<Props> = () => {
    ...
    return (
        <aside>
            ...
            <SliderOptions children={cachedInfo.cachedUsers.map((user) => <div class="slider-option"><ModalCardButton textTitle={user.name} children={<></>} textButton={user.name} imgSrc={user.image} /></div>)} />
